    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            // Allows PostHog EU endpoint, barcode scanner WASM, and other necessary domains
      ...
      },
      {
        ...
        headers: [
          ...
          },
          {
            ...
            // Allows connections to Supabase, OpenFoodFacts, DigitalOcean API, Google Fonts, PostHog, and barcode scanner WASM
            key: 'Content-Security-Policy',
            value:
