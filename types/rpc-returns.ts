...
// =============================================================================
// INVENTORY SCHEMA - DRAFT BATCH MANAGEMENT
// =============================================================================

/** Input for activate_draft_batch */
export interface ActivateDraftBatchInput {
  p_batch_id: string
  p_expiry_date: string // ISO date
  p_quantity?: number
  p_user_id?: string
}

/** Response from activate_draft_batch */
...
/** Input for ignore_draft_batch */
export interface IgnoreDraftBatchInput {
  p_batch_id: string
  p_quantity?: number
  p_user_id?: string
}

/** Response from ignore_draft_batch */
...
/** Response from restore_ignored_batch */
export interface RestoreIgnoredBatchResponse {
  success: boolean
  message: string
...
/** Single draft batch within a product group */
...
/** Product with its draft batches - from get_draft_batches_by_product */
...
/** Category summary for draft batches */
export interface DraftBatchCategorySummary {
...
/** Response from get_draft_batches_summary */
export interface DraftBatchesSummaryResponse {
  ...
  by_category: DraftBatchCategorySummary[]
  error?: string
}

/** Single ignored batch within a product group */
...
/** Product with its ignored batches - from get_ignored_batches_by_product */
export interface IgnoredBatchesByProduct {
  product_id: string
  product_name: string
  product_brand: string | null
  category_name: string
...
/** Category summary for ignored batches */
export interface IgnoredBatchCategorySummary {
  category_code: string
  category_name: string
...
/** Response from get_ignored_batches_summary */
export interface IgnoredBatchesSummaryResponse {
  total_ignored_batches: number
  total_units: number
  products_with_ignored: number
  by_category: IgnoredBatchCategorySummary[]
}

// =============================================================================
// INVENTORY SCHEMA - DELIVERY & BATCH CREATION
// =============================================================================

/** Single item for log_delivery_create_drafts input */
export interface DeliveryItem {
  product_id: string
  quantity: number
}

/** Single result item from log_delivery_create_drafts */
...
/** Response from log_delivery_create_drafts */
export interface LogDeliveryResponse {
  success: boolean
  total_items: number
...
/** Recent delivery product - from get_recent_delivery_products */
export interface RecentDeliveryProduct {
  product_id: string
  product_name: string
  last_delivery_quantity: number | null
  last_expiry_days: number | null
...
export interface RpcResultMap {
  // Inventory - Draft Batch Management
  activate_draft_batch: ActivateDraftBatchResponse
  ignore_draft_batch: IgnoreDraftBatchResponse
  restore_ignored_batch: RestoreIgnoredBatchResponse
  get_draft_batches_by_product: DraftBatchesByProduct[]
  get_draft_batches_summary: DraftBatchesSummaryResponse
  get_ignored_batches_by_product: IgnoredBatchesByProduct[]
  get_ignored_batches_summary: IgnoredBatchesSummaryResponse

  // Inventory - Delivery & Creation
  log_delivery_create_drafts: LogDeliveryResponse
  get_recent_delivery_products: RecentDeliveryProduct[]
...
/** @deprecated Use DraftBatchesSummaryResponse instead */
export type DraftBatchesSummary = DraftBatchesSummaryResponse

/** @deprecated Use DraftBatchesByProduct instead */
export type ProductWithDraftBatches = DraftBatchesByProduct

/** @deprecated Use ActivateDraftBatchResponse instead */
export type ActivateDraftBatchResult = ActivateDraftBatchResponse

/** @deprecated Use IgnoreDraftBatchResponse instead */
export type IgnoreDraftBatchResult = IgnoreDraftBatchResponse

/** @deprecated Use LogDeliveryResponse instead */
export type LogDeliveryResult = LogDeliveryResponse

/** @deprecated Use DeliveryResultItem instead */
export type DeliveryItemResult = DeliveryResultItem

/** @deprecated Use RestoreIgnoredBatchResponse instead */
export type RestoreIgnoredBatchResult = RestoreIgnoredBatchResponse

/** @deprecated Use IgnoredBatchesSummaryResponse instead */
export type IgnoredBatchesSummary = IgnoredBatchesSummaryResponse

/** @deprecated Use IgnoredBatchesByProduct instead */
export type ProductWithIgnoredBatches = IgnoredBatchesByProduct
