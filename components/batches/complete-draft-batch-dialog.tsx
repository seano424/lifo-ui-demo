      ...
      <DialogContent className="sm:max-w-[550px]">
        ...
        <div className="space-y-5 py-4">
          ...
          <div className="rounded-xl border-2 border-slate-200 dark:border-slate-700 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 p-5 space-y-4 shadow-sm">
            <div>
              <Label className="text-xs uppercase tracking-wide text-muted-foreground font-semibold">Product</Label>
              <p className="font-bold text-lg mt-1 text-slate-900 dark:text-slate-100">{batch.products?.name || 'Unknown Product'}</p>
            </div>
