...
const typographyVariants = cva('', {
  variants: {
    variant: {
      h1: 'scroll-m-20 text-4xl sm:text-5xl font-extrabold tracking-tight md:text-6xl font-heading leading-none',
      h2: 'scroll-m-20 text-3xl font-extrabold tracking-tight font-heading leading-none',
      h3: 'scroll-m-20 text-2xl font-extrabold tracking-tight font-heading leading-none',
      h4: 'scroll-m-20 text-xl font-extrabold tracking-tight font-heading leading-none',
