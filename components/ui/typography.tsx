...
const typographyVariants = cva('', {
  variants: {
    variant: {
      h1: 'scroll-m-20 text-4xl sm:text-5xl font-black font-heading',
      h2: 'scroll-m-20 text-3xl sm:text-4xl font-black font-heading',
      h3: 'scroll-m-20 text-2xl lg:text-3xl font-black font-heading',
