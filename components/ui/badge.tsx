...
const badgeVariants = cva(
  'inline-flex items-center capitalize justify-center gap-1.5 rounded-lg whitespace-nowrap transition-colors duration-200 ease-in-out [&_svg]:pointer-events-none [&_svg]:size-3 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
