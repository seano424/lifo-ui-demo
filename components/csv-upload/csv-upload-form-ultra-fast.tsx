...
export function UltraFastCSVUploadForm({ storeId, onUploadComplete }: CSVUploadFormProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Lightning-fast processing with automatic duplicate skipping
        </p>
      </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <Badge variant="secondary">
                Duplicates auto-skipped during upload
              </Badge>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600">
                  {uploadResult.performance_metrics.items_per_second}
                </div>
            ...
            {uploadResult.duplicates_skipped?.length > 0 && (
              <details className="bg-white rounded p-4 border">
                ...
                <div className="mt-3 space-y-2 max-h-40 overflow-y-auto">
                  {uploadResult.duplicates_skipped.map((dup: any, index: number) => (
                    <div key={index} className="text-sm p-2 bg-gray-50 rounded border-l-4 border-yellow-400">
                      <div className="font-semibold">{dup.sku} - {dup.product_name}</div>
      ...
      <Card className="p-4 bg-blue-50 border-blue-200">
        <div className="text-center text-sm text-blue-800">
          ...
          <div>
            • 100 items in &lt;10 seconds • Automatic duplicate skipping • 
            Real-time metrics • Zero complex decisions needed
          </div>
        </div>
      </Card>
    </div>
