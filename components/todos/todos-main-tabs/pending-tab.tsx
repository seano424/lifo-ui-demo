...
export function PendingTab({ filters, pageSize = 20 }: Omit<PendingTabProps, 'onCountUpdate'>) {
...
export function PendingTabWithCounts({ filters, pageSize = 20, onCountUpdate }: PendingTabProps) {
  const t = useTranslations('todos')
  const tErrors = useTranslations('errors.common')
