    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="flex justify-center pt-4">
        <Button
          ...
          className="w-full md:w-auto py-3 text-lg font-medium rounded-2xl bg-gradient-to-r from-primary-900 to-secondary-800 text-white hover:opacity-90 transition-opacity shadow-lg shadow-primary-800/20"
        >
          {t('submit')}
        </Button>
      </div>
