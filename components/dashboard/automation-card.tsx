      ...
      <Card className="overflow-hidden flex flex-col gap-0 bg-card">
        ...
        <div className="divide-y divide-muted">
          {rules.map(rule => (
            <button
              ...
              className="flex sm:items-center justify-between px-6 py-3 transition-colors hover:bg-gray-50 hover:text-gray-900 dark:hover:bg-secondary-900/10 dark:hover:text-secondary-100 cursor-pointer w-full text-left"
            >
        ...
        <Typography variant="p">
          <button
            ...
            className="flex items-center gap-2 hover:bg-gray-50 hover:text-gray-900 dark:hover:bg-secondary-900/10 dark:hover:text-secondary-100 px-6 py-5 border-t border-muted w-full text-left"
          >
