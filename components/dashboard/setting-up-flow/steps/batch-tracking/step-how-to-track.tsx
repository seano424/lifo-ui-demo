...
function ModeBadge({ mode }: { mode: 'auto' | 'manual' }) {
  return (
    <span className="inline-flex justify-center items-center gap-1.5 p-2 text-sm font-medium rounded-lg border border-muted bg-secondary-50 text-secondary-700 dark:bg-background dark:border-muted dark:text-secondary-300">
