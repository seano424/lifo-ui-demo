      ...
      <Card className={className}>
        ...
        <CardContent className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              {currentAlertLevel === 'conservative' && (
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold">{t('levels.conservative')}</span>
                </div>
              )}
              {currentAlertLevel === 'balanced' && (
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 bg-yellow-500 rounded-full" />
                  <span className="font-bold">{t('levels.balanced')}</span>
                </div>
              )}
              {currentAlertLevel === 'proactive' && (
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 bg-primary-500 rounded-full" />
                  <span className="font-bold">{t('levels.proactive')}</span>
                </div>
              )}
            </div>
          ...
          <div className="space-y-4">
            <Label className="text-sm font-bold">{t('currentPreference')}</Label>
          ...
          {showAdvanced && (
            <div className="space-y-4 p-4 bg-muted/30 rounded-2xl border border-dashed">
              <div className="text-sm space-y-3">
                <p className="font-bold">{t('technical.thresholds')}</p>
                ...
                <Separator />
                <div className="space-y-1">
                  <p className="text-xs font-bold">{t('technical.howScoringWorks')}</p>
