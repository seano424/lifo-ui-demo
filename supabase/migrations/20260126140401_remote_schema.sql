...
drop index if exists "sales"."idx_transactions_square_line_item_unique";

drop index if exists "sales"."idx_transactions_square_order";
...
alter table "sales"."transactions" drop column "external_source";

alter table "sales"."transactions" drop column "square_line_item_uid";

alter table "sales"."transactions" drop column "square_order_id";

alter table "sales"."transactions" drop column "square_team_member_id";
