-- Migration: fix_get_product_detail_rpc_column_names
--
-- The remote_schema pull (20260217164812) overwrote the get_product_detail function
-- with an older version that used square_quantity/square_quantity_updated_at/total_stock
-- instead of store_quantity/store_quantity_updated_at/batch_quantity.
-- This re-applies the correct version so the TypeScript client receives the expected field names.
