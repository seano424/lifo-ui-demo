...
CREATE INDEX IF NOT EXISTS idx_transactions_square_order
  ON sales.transactions(square_order_id, square_line_item_uid)
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_transactions_square_line_item_unique
  ON sales.transactions(square_order_id, square_line_item_uid)
  WHERE square_order_id IS NOT NULL AND square_line_item_uid IS NOT NULL;
