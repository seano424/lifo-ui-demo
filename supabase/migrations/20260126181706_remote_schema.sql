...
revoke delete on table "public"."store_products" from "anon";

revoke insert on table "public"."store_products" from "anon";

revoke references on table "public"."store_products" from "anon";

revoke select on table "public"."store_products" from "anon";

revoke trigger on table "public"."store_products" from "anon";

revoke truncate on table "public"."store_products" from "anon";

revoke update on table "public"."store_products" from "anon";

revoke delete on table "public"."store_products" from "authenticated";

revoke insert on table "public"."store_products" from "authenticated";

revoke references on table "public"."store_products" from "authenticated";

revoke select on table "public"."store_products" from "authenticated";

revoke trigger on table "public"."store_products" from "authenticated";

revoke truncate on table "public"."store_products" from "authenticated";

revoke update on table "public"."store_products" from "authenticated";

revoke delete on table "public"."store_products" from "service_role";

revoke insert on table "public"."store_products" from "service_role";

revoke references on table "public"."store_products" from "service_role";

revoke select on table "public"."store_products" from "service_role";

revoke trigger on table "public"."store_products" from "service_role";

revoke truncate on table "public"."store_products" from "service_role";

revoke update on table "public"."store_products" from "service_role";
...
alter table "public"."store_products" drop constraint "store_products_pkey";

drop index if exists "public"."store_products_pkey";
