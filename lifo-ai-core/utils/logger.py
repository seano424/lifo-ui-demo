...
class StructuredLogger:
    ...
    def __init__(self, service_name: str = "lifo-ai-core", log_level: str = "INFO"):
...
def get_logger(service_name: str = "lifo-ai-core", log_level: str = "INFO") -> StructuredLogger:
...
def log_csv_processing(store_id: str, filename: str, row_count: int, success_count: int, error_count: int):
...
def log_database_operation(operation: str, table: str, affected_rows: int, execution_time: float):
