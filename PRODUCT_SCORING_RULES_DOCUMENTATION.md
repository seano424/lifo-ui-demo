...
*This documentation reflects the current implementation as of the scoring engine located in `lifo_api/app/core/scoring.py`. For the most up-to-date formulas and thresholds, refer to the source code.*