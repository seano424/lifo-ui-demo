...
# Run with coverage
python -m pytest tests/ --cov=etl --cov=scoring --cov-report=html
```
...
```bash
# Clone repository
git clone https://github.com/your-org/lifo-ai-core.git
cd lifo-ai-core
...
- **Documentation**: [docs.lifoai.com/core](https://docs.lifoai.com/core)
- **Issues**: [GitHub Issues](https://github.com/your-org/lifo-ai-core/issues)
- **Discussions**: [GitHub Discussions](https://github.com/your-org/lifo-ai-core/discussions)
