  ...
  return withPerformanceTracking(
    ...
    async () => {
      ...
      const { data, error } = await supabase.schema('inventory').rpc('get_batches_paginated', {
        ...
        p_exclude_drafts: filters.excludeDrafts ?? undefined,
        p_location_code: filters.location_code ?? undefined,
        p_supplier: filters.supplier ?? undefined,
        p_has_stock: filters.hasStock ?? undefined,
        p_expiring_in_days: filters.expiringInDays ?? undefined,
        p_expiry_date_from: filters.expiry_date_from ?? undefined,
        p_expiry_date_to: filters.expiry_date_to ?? undefined,
        p_received_date_from: filters.received_date_from ?? undefined,
        p_received_date_to: filters.received_date_to ?? undefined,
