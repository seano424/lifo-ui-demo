...
from app.models.base import (
    ConfigurableModel, TimestampMixin, PaginationParams, PaginationResponse,
    SortParams, FilterParams, UrgencyLevel, BatchStatus, decimal_to_float
)
...
class InventoryFilterParams(FilterParams):
    ...
    expiring_days: Optional[int] = Field(None, ge=0, le=365, description="Items expiring within N days")
...
class BulkActionRequest(BaseModel):
    ...
    batch_ids: List[str] = Field(..., min_items=1, max_items=100, description="List of batch IDs")
