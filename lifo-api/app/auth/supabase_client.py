...
class SupabaseClient:
    ...
    async def authenticate_with_email_password(self, email: str, password: str) -> Optional[Dict[str, Any]]:
        """
        ...
        try:
            async with httpx.AsyncClient() as client:
                ...
                if response.status_code == 200:
                    ...
                    self.session_expires_at = datetime.utcnow() + timedelta(seconds=session_data.get('expires_in', 3600))
    ...
    async def get_valid_access_token(self) -> Optional[str]:
        ...
        if self.session_expires_at and self.session_expires_at > datetime.utcnow() + timedelta(minutes=5):
