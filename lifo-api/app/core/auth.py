...
async def validate_store_access(
    ...
    try:
        ...
        logger.error("Store access validation error", 
                    store_id=store_id, user_id=user_id, error=str(e))
        return False
...
async def validate_global_product_access(
    ...
    try:
        ...
        logger.error("Global product access validation error", 
...
async def validate_donation_access(
    ...
    try:
        ...
        logger.error("Donation access validation error", 
                    user_id=user_id, store_id=store_id, action=action, error=str(e))
        return False
...
class PermissionChecker:
    ...
    async def check_donation_access(self, action: str = "read", store_id: Optional[str] = None) -> bool:
