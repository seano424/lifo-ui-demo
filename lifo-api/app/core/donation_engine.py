...
from app.core.eu_food_safety import EUFoodSafetyValidator, EUComplianceResult, DonationEligibility
...
class DonationDecisionEngine:
    ...
    def evaluate_donation_opportunity(self,
                                    batch_data: Dict[str, Any],
                                    scoring_result: Optional[ScoringResult] = None,
                                    current_temperature: Optional[float] = None,
                                    packaging_condition: str = "good") -> DonationRecommendation:
        """
        ...
        try:
            ...
            self.logger.info("Donation opportunity evaluated",
            ...
            self.logger.error("Donation opportunity evaluation failed",
                            batch_id=batch_data.get("batch_id"),
                            error=str(e))
    ...
    def _analyze_donation_vs_alternatives(self,
                                        compliance_result: EUComplianceResult,
                                        margin_percent: float,
                                        days_to_expiry: int,
                                        total_value: float,
                                        scoring_result: Any,
                                        current_quantity: float) -> Dict[str, Any]:
        ...
        if decision in [DonationDecision.DONATE_IMMEDIATELY, DonationDecision.DONATE_SCHEDULED]:
    ...
    def _calculate_financial_impact(self,
                                  ...
                                  margin_percent: float,
                                  decision: DonationDecision) -> Dict[str, float]:
        ...
        if decision in [DonationDecision.DONATE_IMMEDIATELY, DonationDecision.DONATE_SCHEDULED]:
            ...
            opportunity_cost = total_selling_value * 0.8  # Revenue foregone (assuming 80% discount would sell)
    ...
    def _determine_timing_and_priority(self,
                                     compliance_result: EUComplianceResult,
                                     days_to_expiry: int,
                                     decision: DonationDecision) -> Dict[str, Any]:
    ...
    def _generate_logistics_requirements(self,
                                       compliance_result: EUComplianceResult,
                                       category: str,
                                       current_quantity: float) -> Dict[str, List[str]]:
    ...
    def _create_fallback_recommendation(self, batch_data: Dict[str, Any], error: str) -> DonationRecommendation:
        """Create safe fallback recommendation when evaluation fails"""
        from app.core.eu_food_safety import EUComplianceResult, DonationEligibility
