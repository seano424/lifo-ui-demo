...
from app.core.scoring import (
    InventoryScorer, ScoringWeights, ScoringInput, ScoringResult,
    ScoringService
)
...
class TestScoringMathematicalVulnerabilities:
    ...
    def test_extreme_numeric_values(self):
        ...
        for quantity, sales, days, cost, selling in extreme_values:
            try:
                ...
                assert 0.0 <= velocity_score <= 1.0, f"Velocity score out of range: {velocity_score}"
    ...
    def test_floating_point_precision_issues(self):
        ...
        for quantity, sales, days, cost, selling in precision_tests:
            ...
            assert velocity_score >= 0.0, f"Negative velocity score due to precision: {velocity_score}"
