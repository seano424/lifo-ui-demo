...
def handle_operation_error(operation: str, error: Exception, user_id: str = None) -> HTTPException:
    """
...
def format_mobile_response(data: Dict[str, Any], processing_time_ms: float) -> Dict[str, Any]:
    """
