...
class CustomExceptionHandler:
    ...
    def database_error_handler(self, request: Request, exc: SQLAlchemyError) -> JSONResponse:
    ...
    def validation_error_handler(self, request: Request, exc: ValidationError) -> JSONResponse:
