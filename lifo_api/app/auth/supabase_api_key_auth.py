    ...
    async def verify_user_token(self, access_token: str) -> APIKeyUser:
        ...
        try:
            ...
            if e.response.status_code == 401:
                ...
                raise SupabaseAPIKeyError("Authentication service unavailable", status_code=503)
...
async def require_permission(permission: str):
    ...
    """
    async def permission_checker(user: APIKeyUser = Depends(get_current_user)) -> APIKeyUser:
        auth = get_api_key_auth()
