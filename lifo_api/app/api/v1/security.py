    ...
    try:
        ...
        comprehensive_stats = {
            ...
            "system_security": {
                ...
                "security_level": "production" if settings.environment == "production" else "development",
    ...
    try:
        ...
        with security_monitor.lock:
            ...
            for event in security_monitor.security_events:
                if event.timestamp >= cutoff_time:
                    ...
                    event_dict["details"] = {
                        k: sanitize_for_logging(v) for k, v in event_dict.get("details", {}).items()
                    }
        ...
        threat_data = {
            ...
            "threat_summary": {
                ...
                "most_common_attack_types": _get_most_common_attack_types(recent_events)
            }
        }
...
async def get_ip_security_profile(
    ...
    try:
        ...
        with security_monitor.lock:
            ...
            recent_events = [
                event.to_dict() for event in ip_events[-20:]  # Last 20 events
            ]
        ...
        profile_data = {
            ...
            "threat_assessment": {
                ...
                "recommendation": _get_ip_recommendation(ip_profile, is_banned, is_whitelisted)
            }
        }
        ...
        raise HTTPException(
            status_code=500,
            detail="Failed to retrieve IP security profile"
        )
...
async def get_security_health(
    ...
    try:
        ...
        with security_monitor.lock:
            ...
            health_score = 100
            health_score -= min(critical_events * 10, 50)  # Critical events reduce score significantly
            health_score -= min(high_events * 5, 30)       # High events reduce score moderately
        ...
        if critical_events > 0:
            issues.append(f"{critical_events} critical security events in the last hour")
        if high_events > 5:
...
def _get_security_recommendations(health_score: int, issues: List[str]) -> List[str]:
    ...
    if health_score < 60:
        ...
        recommendations.append("Security posture is excellent - maintain current settings")
