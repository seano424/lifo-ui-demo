...
class OCRConfigurationManager:
    ...
    def _create_mobile_fast_config(self) -> dict:
        ...
        return {
            ...
            "confidence_thresholds": ConfidenceThresholds(
                date_extraction={"high": 0.85, "medium": 0.70, "low": 0.50},
                barcode_detection={"high": 0.90, "medium": 0.75, "low": 0.55},
                product_name_extraction={"high": 0.80, "medium": 0.65, "low": 0.45},
                text_recognition={"high": 0.85, "medium": 0.70, "low": 0.50},
            ),
            ...
            "engines": {"primary": OCREngine.GOOGLE_VISION, "fallback": None},
        }
    ...
    def _create_accuracy_high_config(self) -> dict:
        ...
        return {
            ...
            "confidence_thresholds": ConfidenceThresholds(
                ...
                product_name_extraction={"high": 0.90, "medium": 0.75, "low": 0.60},
                text_recognition={
                    "high": 0.90,
                    "medium": 0.80,
    ...
    def _create_balanced_config(self) -> dict:
        ...
        return {
            ...
            "confidence_thresholds": ConfidenceThresholds(
                date_extraction={"high": 0.90, "medium": 0.75, "low": 0.60},
                barcode_detection={"high": 0.92, "medium": 0.80, "low": 0.65},
                product_name_extraction={"high": 0.85, "medium": 0.70, "low": 0.55},
                text_recognition={"high": 0.87, "medium": 0.75, "low": 0.60},
            ),
            "performance": PerformanceConfig(
                timeout_seconds=10,
    ...
    def _create_batch_optimized_config(self) -> dict:
        ...
        return {
            ...
            "confidence_thresholds": ConfidenceThresholds(
                date_extraction={"high": 0.88, "medium": 0.73, "low": 0.58},
                barcode_detection={"high": 0.90, "medium": 0.78, "low": 0.63},
                product_name_extraction={"high": 0.83, "medium": 0.68, "low": 0.53},
                text_recognition={"high": 0.85, "medium": 0.73, "low": 0.58},
            ),
            "performance": PerformanceConfig(
                timeout_seconds=15,
        ...
        return {
            ...
            "experiments": {
                ...
                "dual_engine_comparison": {
                    ...
                    "variants": [
                        "google_vision_only",
                        "google_vision_tesseract_fallback",
                    ],
                },
    ...
    def validate_configuration(self) -> dict[str, bool]:
        ...
        try:
            ...
            validation_results["image_processing"] = (
                0 < img_config.max_width <= 2048
                and 0 < img_config.max_height <= 2048
                and 50 <= img_config.jpeg_quality <= 100
            )
            ...
            validation_results["performance"] = (
                0 < perf_config.timeout_seconds <= 60
                and 0 < perf_config.max_concurrent_requests <= 100
                and 0 < perf_config.thread_pool_workers <= 20
            )
