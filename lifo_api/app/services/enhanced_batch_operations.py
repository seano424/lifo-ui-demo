...
class EnhancedBatchOperations:
    ...
    async def create_batches_from_csv_optimized(
        ...
        try:
            ...
            result.update({
                ...
                "csv_to_batch_conversion_rate": len(batch_requests) / len(csv_data) * 100,
    ...
    async def batch_action_workflow(
        ...
        try:
            ...
            for action in actions:
                ...
                if action_type in ["discount", "discount_moderate", "discount_aggressive"]:
    ...
    async def _process_action_group(
        ...
        if operations:
            ...
            tracking_records = result["successful"]  # One tracking record per successful operation
