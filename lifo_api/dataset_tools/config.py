...
class OpenFoodFactsConfig:
    ...
    countries: List[str] = field(
        default_factory=lambda: ["france", "germany", "italy", "spain"]
    )
...
class FoodiMLConfig:
    ...
    european_keywords: List[str] = field(
        default_factory=lambda: [
            "europe",
            "eu",
            "france",
...
class DatasetConfig:
    ...
    # Base directories
    data_dir: Path = field(
        default_factory=lambda: Path("/home/slim/lifo-app/lifo_api/dataset_tools/data")
    )
    output_dir: Path = field(
        default_factory=lambda: Path(
            "/home/slim/lifo-app/lifo_api/dataset_tools/output"
        )
    )
    cache_dir: Path = field(
        default_factory=lambda: Path("/home/slim/lifo-app/lifo_api/dataset_tools/cache")
    )
    ...
    supported_languages: List[str] = field(
        default_factory=lambda: ["en", "fr", "de", "it", "es"]
    )
